          ...
          <ul className="space-y-4 text-gray-300">
            ...
            >
              ...
              <span>
                ...
                <strong className="text-indigo-300">FastAPI, Django</strong>
              </span>
            </motion.li>
            <motion.li
              initial={{ opacity: 0, x: -20 }}
            ...
            >
              <span className="mr-2 text-indigo-400">-</span>
              <span>
                👨‍💻 I'm currently learning how to code properly and I have at
            ...
            >
              ...
              <span>
                ⚡ Fun fact{" "}
                <strong className="text-indigo-300">I use Arch btw</strong>
              </span>
            </motion.li>
          </ul>
        </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-3 md:grid-cols-5 gap-6 relative z-10">
              {techStack.map((tech, index) => (
                ...
                >
                  <div
                    className={`text-3xl md:text-4xl mb-2 ${tech.color} group-hover:scale-110 transition-transform duration-300`}
                  >
                    {tech.icon}
                  </div>
