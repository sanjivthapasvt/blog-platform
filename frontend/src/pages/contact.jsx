      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          >
            ...
            <h2 className="text-2xl font-bold mb-8 relative z-10 group-hover:text-indigo-300 transition-colors duration-300">Contact Information</h2>
            <div className="space-y-6 relative z-10">
              ...
              <div className="flex items-center space-x-4 group cursor-pointer">
                ...
                <span className="text-gray-300 group-hover:text-indigo-300 transition-colors">{contactInfo.location}</span>
              </div>
              <div className="flex items-center space-x-4 group cursor-pointer">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/5 to-purple-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <h2 className="text-2xl font-bold mb-8 relative z-10 group-hover:text-indigo-300 transition-colors duration-300">Connect With Me</h2>
